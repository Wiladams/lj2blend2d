--[[
    These are some routines that help with creating various kinds of curves.
    It is largely an exploration of utilizing matrix representations of splines
    to reduce the amount of specialized code needed.

Origin
    BanateCAD - https://github.com/Wiladams/BanateCAD/blob/master/core/cubiccurves.lua
--]]
...
--
--=======================================
local function cubic_vec3_to_cubic_vec4(cps)
	return {
...
local function vec43_to_vec44(mesh)
	return {
...
-- Blending Functions
local function cubic_hermite_M()
	return {
	{2, -2, 1, 1},
	{-3, 3, -2, -1},
	{0, 0, 1, 0},
...
local function cubic_catmullrom_M()
	return {
	{-1,  3, -3,  1},
	{ 2, -5,  4, -1},
	{-1,  0,  1,  0},
...
local function cubic_bspline_M()
	return {
	{-1, 2, -3, 1},
	{3, -6, 3, 0},
	{-3, 0, 3, 0},
